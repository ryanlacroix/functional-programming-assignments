...
;accessor for quote
(define (text-of-quotation exp) (display exp)(cadr exp))
...
(define (make-lambda parameters body) ;;;;;;;;;;;;;;;;; note here
...
(define (make-let exp)
  (cons (make-lambda (map car (car (cdr exp))) (cdr (cdr exp))) (map cadr (car (cdr exp)))))
